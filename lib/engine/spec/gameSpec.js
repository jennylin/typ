...
describe("Q", function() {
  ...
  it ("creates spaces", function() {
    ...
    expect(game.deck.cards).toBeTruthy();
    expect(game.deck.card).toBeUndefined();
    expect(game.turnUp).toBeTruthy();
    expect(game.turnUp.card).toBeTruthy();
  });
  ...
  it ("moves pieces", function() {
    ...
    game.cards.move({ first:1 }).to(game.turnUp);
